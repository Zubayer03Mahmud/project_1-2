...
void order:: placeorder()
{
    ...
    do
    {
        ...
        cin >> x;
        cout << can.product_num[x-1] << ":" << can.product_name[x-1] << " has been added to your cart" << endl;
...
void storeorder:: place_order()
{
    ...
    do
    {
        cout << "ENTER THE PRODUCT NUMBER YOU WANT TO ORDER: ";
        cin >> s;
        cout << store.prod_num[s-1] << ":" << store.prod_name[s-1] << " has been added to your cart" << endl;
        total_cost += store.prodt_price[s-1];
        cout<<"DO WANT TO CONTINUE(y/n): ";
        cin >> choice3;
    }
...
void vendingorder :: place_vorder()
{
    int v;
    float total_cost = 0;
    char ch;
    do
    {
        cout << "ENTER THE PRODUCT NUMBER YOU WANT TO ORDER: ";
        cin >> v;
        cout << venMan.product_vnum[v-1] << ":" << venMan.product_vname[v-1] << " has been added to your cart" << endl;
        total_cost +=venMan.prodv_price[v-1];
        cout<<"DO WANT TO CONTINUE(y/n): ";
        cin >> ch;
    }
    while(ch=='y'||ch=='Y');
...
void StoreService :: product_Info()
{
    ...
    prod_name = {"Lays chips", "Sun chips", "Shampoo", "Soap", "Dan cake","Detergent", "Fit biscuits", "Omelette","Chola boot","Dim bon"};
    prodt_price= {20,15,10,15,20,10,20,20,15,30};

}

void StoreService :: Show_product_Info()
{
    ...
    cout<<"1. Place an oder"<<endl;
    cout<<"2. Back to Service page"<<endl;
    int ch;
    cin>>ch;
    if(ch==1)
    {
...
//vending member function

void VendingMachine :: van_product()
{
    ...
    product_vname = {"Lays chips", "Sun chips","SMC-Plus","Dan cake","Pepsi", "Fit biscuits", "Nutty biscuits","Potata biscuits","7-UP","Mojo"};
    prodv_price= {20,15,30,20,25,20,20,20,25,25};

}

void VendingMachine :: Show_vproduct()
{
